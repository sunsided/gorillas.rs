...
This project is indexed by GitNexus as **gorillas** (422 symbols, 1044 relationships, 37 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
