...
This project is indexed by GitNexus as **gorillas** (421 symbols, 1039 relationships, 37 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
